...
melody_voice = abjad.OrderedDict([
    ("blue", abjad.OrderedDict([
        ...
        ("p3", abjad.OrderedDict([
            ...
            (8, abjad.PitchSegment("a''' f''' b'''' ef''' d''' g'''")),
...
tremolo_voice = abjad.OrderedDict([
    ("blue", abjad.OrderedDict([
        (2, abjad.OrderedDict([
            ("v1", abjad.PitchSegment("e, c, fs, cs, cs, e,")),
        ...
        (4, abjad.OrderedDict([
            ("v1", abjad.PitchSegment("e' c' fs' cs' cs' a'")),
            ("v2", abjad.PitchSegment("d' g' e' b as' gs'")),
            ("v3", abjad.PitchSegment("a' cs'' bf' c'' c'' d''")),
            ])
         ),
        (5, abjad.OrderedDict([
    ...
    ("green", abjad.OrderedDict([
        (2, abjad.OrderedDict([
            ...
            ("v2", abjad.PitchSegment("a, f, b, f cs fs,")),
