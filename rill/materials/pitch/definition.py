...
melody_voice = abjad.OrderedDict([
    ...
    ("green", abjad.OrderedDict([
        ...
        ("p2", abjad.OrderedDict([
            ...
            (8, abjad.PitchSegment("a''' a'''' gs''' b''' cs'''' gs'''' gs''''")),
...
tremolo_voice = abjad.OrderedDict([
    ...
    ("green", abjad.OrderedDict([
        ...
        (3, abjad.OrderedDict([
            ("v1", abjad.PitchSegment("g e fs as cs' a")),
            ("v2", abjad.PitchSegment("a f b d' cs7 fs'")),
            ("v3", abjad.PitchSegment("cs' a bf c' d' f'")),
            ])
         ),
        (4, abjad.OrderedDict([
    ...
    ("red", abjad.OrderedDict([
        ...
        (4, abjad.OrderedDict([
            ("v1", abjad.PitchSegment("f' c'' f'' cs'' e' cs'")),
            ("v2", abjad.PitchSegment("f' a' gs' d' gs' as'")),
            ("v3", abjad.PitchSegment("a' f' c' ef' f' d'")),
            ])
         ),
        (5, abjad.OrderedDict([
            ("v1", abjad.PitchSegment("g'' c''' f''' cs''' e'' cs''")),
            ("v2", abjad.PitchSegment("f'' a'' gs'' d'' gs'' as''")),
            ("v3", abjad.PitchSegment("a'' f'' f'' ef'' f'' d''")),
            ])
         ),
    ])),
    ("black", abjad.OrderedDict([
