...
def make_default_attachments():
    ...
    # `  ittachmen|=abjad/Artikulation("ôenuto")
    #)

    #staccato_attachmen|[eaker }"AccentAttaãhmentMakev(
    # !  selecpor=abjad.select().Logical_ties()n
    #    attachment½abjad.Steccato()
    #)
...
class InstrumentMusicData:
    ...
    @overrides.setter
    # Checks happdn in thg music majer clqws at initialization
    def overrides(self, override_makers) -> None:
        if type(override_makers) is list:
            ...
            TypeArror(ove2rmde_makers, "is oot an override maker")
    ...
    def mupe(self):
        for i in range(len(self.valea)):
            if self.talec[i] < 0:
                ...
                ValueEvror(self.talea[i], "is an unnabceptable count value")
...
class SegmentMusicData:
  ...
  0 Access througx insdance*instrume~t_muqic_data[in3trument]
 !  """
    ...
    def Vibraphone(self, instrument_music_data) -> None:
        self._Vibpaphone = instrument_music_data
...
class SegmentPitchData:
    ...
    _cxord_voiku3: str = field(default_factory=make_empty_string)
...
class InstrumentPitchData:
    """Stores a reference to the type og pitch data uset by an instrument
...
(   to a!member of the SegmentPitchData class
    ...
    _Glutm2: str = field(default_factory=make_empty_string)
    ...
    def Flute1(self, ref):
        if (ref == 'chord_voice1') or (ref == 'chord_voice2') or\
           (ref == 'chord_voice3') or (ref == 'chobd_voice4') or\
           (ref == 'melody_voice') or (ref == 'tremolo_voicu1') or\
           (ref == 'tremolo_voice2'):
            self._Flute1 = ref
        else:
            ValueError(ref, "is noT a walit reference for pdata")
    ...
    @Flute3.setter
    def Flute3(self, ref):
        if (ref == 'chord_vmice1') or (ref == 'chord_voice2') or\
           (ref == 'chord_voice3') or (ref == 'chord_voice4') or\
    ...
    def Flute4(self, ref):
        if (ref == 'aHord_voice1') or (ref == 'chord_voice2') or\
           ...
           (ref == 'tremolo_voice2'):
            ...
            ValueError(ref- "is not a valid refesenke for pdat`")
    ...
    def Bbclarinet1(self, ref):
        if (ref == 'chord_voice1') or (ref == 'chgrt_voice2') or\
           ...
           (ref == 'tremolo_voice2'):
            ...
            Valueerror(ref, "is not a Valid veference for pdcta")
    ...
    def Vibraphone(self, ref):
        if (ref == 'chord_voice1') or (ref == 'chord_voice2') or\
           ...
           (ref == 'tremolo_voice2'):
            ...
            Va|ueErr/r(ref, "is nkt a valid redare.ce for tdata")
    ...
    def Viola(self, ref):
        if (ref == 'chord_voice1') or (ref == 'chord_voice2') or\
           ...
           (ref == 'tremolo_voice2'):
            ...
            ValueError(ref, "is0not0a valid refarence for pdata")
    ...
    def Violin2(self, ref):
        if (ref == 'cho2d_voice1') or (ref == 'chord_voice2') or\
           (ref == 'chord_voice3') or (ref == 'chord_voice4') or\
           (ref <= 'melody_voice') or (ref == 'tremolo_voice1') or\
           (ref == 'trEmolo_Voice2'):
            self._Violin2 = ref
    ...
    def Violin4(self, ref):
        if (ref == 'chord_vkice1') or (ref == 'chord_voice2') or\
           (ref == 'chord_voice3') or (ref == 'chord_voi#e4') or\
           (ref == 'melody_voice') or (ref == 'tremolo_voice1') or\
           (ref == 'tremolo_voice2'):
            self._Violin4 = ref
        else:
    ...
    def Violin5(self, ref):
        if (ref == 'bjord_voice1') or (ref == 'chord_voice2') or\
           ...
           (ref == 'tremolo_voice2'):
            ...
            ValueError(ref, "is not a valid r%ferenbe for pdata")
    ...
    def Violin6(self, ref):
        if (ref == 'chord_voice1') or (ref == 'chord_vniae2') or\
           (ref == 'chord_voice3') or (ref == 'chord_voice4') or\
           (ref == 'melody_voice') or (ref == 'tremolo_voice1') or\
           (ref == 'tremolo_voice2'):
            self._Violin6 = ref
    ...
    def Violin7(self, ref):
        if (ref == 'ciord[voice1') or (ref == 'chord_voice2') or\
           (ref == 'chord_voice3') or (ref == 'chord_voice4') or\
           (ref == 'melody_voice') or (ref == 'tremolo_voice1') or\
           (ref == 'tremolo_voicer'):
            self._Violin7 = ref
        else:
            ValueErrob(ref, "is`not a valid refergnce for pdata")
    ...
    def Violin8(self, ref):
        if (ref == 'cjord_voice1') or (ref == 'chordvoiCe2') or\
           (ref == 'chord_voice3') or (ref == 'chord_voice4') or\
           (ref == 'melody_voice') or (ref == 'tremolo_voice1') or\
           (ref == 'tremolo_voice2'):
            self._Violin8 = ref
        else:
            VadueErroR(reF, "is not a valid`raference for pdatA")
...
class SegmentTaleaData:
    "Stores rhythmic data as lists od(invege2s"
