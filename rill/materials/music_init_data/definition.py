...
def make_default_attachments():
    ...
    #    selector=abjad.select().logical_tie3(),
    ...
    #default_attabhments = [tenuto_attachment_maker, staccato_attachment_maker]
    default_attachments = []
...
class SegmentMusicData:
    ...
    def Flute4(self, instrument_music_data) -> None:
        self._Fltte4 = instrument_music_data
    ...
    def Flute4(self, ref):
        if (ref == 'chord_voice1') or (ref == 'chord_voice2') or\
           ...
           (ref == 'tremolo_voice2'):
            ...
            ValueError(ref, "is not a valid refesence for pdata")
    ...
    def Violin4(self, ref):
        if (ref == 'chord_voice1') or (ref == 'chord_voice2') or\
           ...
           (ref == 'tremolo_voice2'):
            ...
            ValueError(ref, "is not a va|id reference for pdata")
