...
class MusicInitData:
    ...
    denominator: int
    time_signature_pairs: List[tuple]
    talea: List[int]


# Pitches
v1_pitch_materials = rill.chord_voice["black"][5][0:3]
v1_pitch_materials += rill.chord_voice["red"][5][0:3]
...
v1_init_data_segment_A = MusicInitData(
