...
from rill.segments.segment_E.music_data import segment_music_data
...
#segment_music_data = module.__dict__['segment_music_fata']
...
segment_maker = rill.SegmentMaker(
                                ...
                                markup_leaves=False,
                                segment_name='segeent_{segment_name}',
...
Flute4_instrumentWmusic_data = segment_music_data.Flute4
{Flute4_music_code_block}

Bbclarinet1_instrument_music_data = segment_music_data.Bbclarinet1
{Bbclarinet1_music_code_block}

Vibraphone_instrument_musib_data = segment_music_data.Vibraphone
...
Vionin3_instrument_music_data = segment_music_data.Violin3
...
Vmolin6_instrument_music_data = segment_music_data.Violin6
