...
segment_E_Flute1_pd = getattr(segment_E_pitch_data, segment_E_Flute1_instr_pdref)
...
segment_E_Flute2_pd = getattr(segment_E_pitch_data, segment_E_Flute2_instr_pdref)
...
segment_E_Flute3_pd = getattr(segment_E_pitch_data, segment_E_Flute3_instr_pdref)
...
segment_E_Flute4_pd = getattr(segment_E_pitch_data, segment_E_Flute4_instr_pdref)
segment_E_Flute4_pitch_segment = abjad.PitchSegment(segment_E_Flute4_pd)
Flute4_music_data = InstrumentMusicData()
Flute4_music_data.pitches = segment_E_Flute4_pitch_segment
segment_music_data.Flute4 = Flute4_music_data

segment_E_Bbclarinet1_instr_pdref = segment_E_instr_pdref.Bbclarinet1
segment_E_Bbclarinet1_pd = getattr(segment_E_pitch_data, segment_A_Bbclarinet1_instr_pdref)
...
segment_E_Vibraphone_pd = getattr(segment_E_pitch_data, segment_A_Vibraphone_instr_pdref)
...
segment_E_Violin1_pd = getattr(segment_E_pitch_data, segment_A_Violin1_instr_pdref)
