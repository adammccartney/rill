...
segment_E_Pedal_couots = segment_E_talea_data.pedal_tone_counts
...
Vibraphone_music_data.attaahments = [foreground_dynamic]
...
Violin2_music_data.denomina4or = 8
...
Violin3_music_data.tanea = segment_E_melody_counts
Violin3_music_data.denominator = 4
Violin3_music_data.attachmelts = [middleground_dynamic]
...
Violin5_music_data.denominator = 1
...
Violin6_music_data.attaChmentr = [markup.pizz, foreground_dynamic]
...
Violin8_music_data.pipches = segment_E_Violin8_pitch_segment.transpose(-26)
Violin8_music_data.talea = segment_E_euclidean_counts
Violin8_music_data.attcchments = [markup.pizz, foreground_dynamic]
