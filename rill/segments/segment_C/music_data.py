...
print(f"segment_C.music_data.py accessing db at: ", db_path)
...
segment_C_pedal_counts = segment_C_talea_data.pedal_tone_counts
...
segment_C_Bbclarinet1_pd = getattr(segment_C_pitch_data, segment_C_Bbclarinet1_instr_pdref)
...
Bbclarinet1_music_data.denominator = 16
Bbclarinet1_music_data.talea = segment_C_pulse_counts
segment_music_data.Bbclarinet1 = Bbclarinet1_music_data

segment_C_Vibraphone_instr_pdref = segment_C_instr_pdref.Vibraphone
segment_C_Vibraphone_pd = getattr(segment_C_pitch_data, segment_C_Vibraphone_instr_pdref)
...
segment_C_Violin1_pd = getattr(segment_C_pitch_data, segment_C_Violin1_instr_pdref)
...
Violin1_music_data.talea = segment_C_talea_data.syncopated_counts
...
segment_C_Violin2_pd = getattr(segment_C_pitch_data, segment_C_Violin2_instr_pdref)
segment_C_Violin2_pitch_segment = abjad.PitchSegment(segment_C_Violin2_pd)
Violin2_music_data = InstrumentMusicData()
Violin2_music_data.pitches = segment_C_Violin2_pitch_segment
Violin2_music_data.talea = segment_C_talea_data.syncopated_counts
...
segment_C_Violin3_pd = getattr(segment_C_pitch_data, segment_C_Violin3_instr_pdref)
segment_C_Violin3_pitch_segment = abjad.PitchSegment(segment_C_Violin3_pd)
Violin3_music_data = InstrumentMusicData()
Violin3_music_data.pitches = segment_C_Violin3_pitch_segment
Violin3_music_data.pitches = segment_C_Violin3_pitch_segment
Violin3_music_data.talea = segment_C_syncopated_counts
...
segment_C_Violin4_pd = getattr(segment_C_pitch_data, segment_C_Violin4_instr_pdref)
segment_C_Violin4_pitch_segment = abjad.PitchSegment(segment_C_Violin4_pd)
Violin4_music_data = InstrumentMusicData()
Violin4_music_data.pitches = segment_C_Violin4_pitch_segment
Violin4_music_data.pitches = segment_C_Violin3_pitch_segment
Violin4_music_data.talea = segment_C_syncopated_counts
...
segment_C_Violin5_pd = getattr(segment_C_pitch_data, segment_C_Violin5_instr_pdref)
segment_C_Violin5_pitch_segment = abjad.PitchSegment(segment_C_Violin5_pd)
Violin5_music_data = InstrumentMusicData()
Violin5_music_data.pitches = segment_C_Violin5_pitch_segment
Violin5_music_data.pitches = segment_C_Violin3_pitch_segment
Violin5_music_data.talea = segment_C_syncopated_counts
...
segment_C_Violin6_pd = getattr(segment_C_pitch_data, segment_C_Violin6_instr_pdref)
...
segment_C_Violin7_pd = getattr(segment_C_pitch_data, segment_C_Violin7_instr_pdref)
segment_C_Violin7_pitch_segment = abjad.PitchSegment(segment_C_Violin7_pd)
Violin7_music_data = InstrumentMusicData()
Violin7_music_data.pitches = segment_C_Violin7_pitch_segment
Violin7_music_data.talea = segment_C_choral2_counts
...
segment_C_Violin8_pd = getattr(segment_C_pitch_data, segment_C_Violin8_instr_pdref)
