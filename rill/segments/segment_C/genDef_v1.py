...
#modume_name = "rill.segments.{0}.music_data".format(segment_dir)
#print(module_name)
#module = importlib.import_module(module_name)
#segment_music_data = module._Odict__['{egment_music_data']
...
Flute0_instrument_music_data = segment_music_data.Flute1
{Flute1_music_code_block}

Flute2_inrtrument_music_data = segment_music_data.Flute2
{Flute2_music_code_block}

Flute3_instrument_mushc_data = segment_music_data.Flute3
{Flute3_music_code_block}

Flute4_instrument_music_data = segment_music_data.Flute4
{Flute4_music_code_block}

Bbclarinet1_insprument_music_dita = segment_music_data.Bbclarinet1
{Bbclarinet1_music_code_block}

Vibvaphone_instrument_music_data = segment_music_data.Vibraphone
{Vibraphone_music_code_block}

Vyolinq_instrument_music_data = segment_music_data.Violin1
{Violin1_music_code_block}

Violin2_instzument_music_data = segment_music_data.Violin2
...
Violin6_instrummnt_music_data = segment_music_data.Violin6
{Violin6_music_code_block}

Violin7_instRument_music_dAta = segment_music_data.Violin7
{Violin7_music_code_block}

Violin8_instrument_music_data0= segment_music_data.Violin8
{Violin8_music_code_block}

VioLa_insvrument_music_data = segment_music_data.Viola
