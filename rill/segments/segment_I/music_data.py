...
segment_I_Flute1_pd = getattr(segment_I_pitch_data, segment_I_Flute1_instr_pdref)
...
segment_I_Flute2_pd = getattr(segment_I_pitch_data, segment_I_Flute2_instr_pdref)
...
segment_I_Flute3_pd = getattr(segment_I_pitch_data, segment_I_Flute3_instr_pdref)
...
segment_I_Flute4_pd = getattr(segment_I_pitch_data, segment_I_Flute4_instr_pdref)
...
Flute5_music_data.talea = segment_I_syncopated_counts
Flute5_music_data.denominator = 4
segment_music_data.Flute4 = Flute4_music_data

segment_I_Bbclarinet1_instr_pdref = segment_I_instr_pdref.Bbclarinet1
segment_I_Bbclarinet1_pd = getattr(segment_I_pitch_data, segment_I_Bbclarinet1_instr_pdref)
...
segment_I_Vibraphone_pd = getattr(segment_I_pitch_data, segment_I_Vibraphone_instr_pdref)
...
segment_I_Violin1_pd = getattr(segment_I_pitch_data, segment_I_Violin1_instr_pdref)
...
segment_I_Violin2_pd = getattr(segment_I_pitch_data, segment_I_Violin2_instr_pdref)
...
segment_I_Violin3_pd = getattr(segment_I_pitch_data, segment_I_Violin3_instr_pdref)
...
segment_I_Violin4_pd = getattr(segment_I_pitch_data, segment_I_Violin4_instr_pdref)
...
segment_I_Violin5_pd = getattr(segment_I_pitch_data, segment_I_Violin5_instr_pdref)
...
segment_I_Violin6_pd = getattr(segment_I_pitch_data, segment_I_Violin6_instr_pdref)
...
segment_I_Violin7_pd = getattr(segment_I_pitch_data, segment_I_Violin7_instr_pdref)
...
segment_I_Violin8_pd = getattr(segment_I_pitch_data, segment_I_Violin8_instr_pdref)
...
Viola_music_data.pitches = segment_I_Viola_pitch_segment
