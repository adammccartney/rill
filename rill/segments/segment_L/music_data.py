...
segment_L_Bbclarinet1_pd = getattr(segment_L_pitch_data, segment_L_Bbclarinet1_instr_pdref)
...
segment_L_Vibraphone_pd = getattr(segment_L_pitch_data, segment_L_Vibraphone_instr_pdref)
...
segment_L_Violin1_pd = getattr(segment_L_pitch_data, segment_L_Violin1_instr_pdref)
...
segment_L_Violin2_pd = getattr(segment_L_pitch_data, segment_L_Violin2_instr_pdref)
...
segment_L_Violin3_pd = getattr(segment_L_pitch_data, segment_L_Violin3_instr_pdref)
...
segment_L_Violin4_pd = getattr(segment_L_pitch_data, segment_L_Violin4_instr_pdref)
...
segment_L_Violin5_pd = getattr(segment_L_pitch_data, segment_L_Violin5_instr_pdref)
...
segment_L_Violin6_pd = getattr(segment_L_pitch_data, segment_L_Violin6_instr_pdref)
...
segment_L_Violin7_pd = getattr(segment_L_pitch_data, segment_L_Violin7_instr_pdref)
...
segment_L_Violin8_pd = getattr(segment_L_pitch_data, segment_L_Violin8_instr_pdref)
...
segment_L_Viola_pd = getattr(segment_L_pitch_data, segment_L_Viola_instr_pdref)
