...
segment_L_choral1_counts = segment_L_talea_data.choral1_counts
segment_L_choral2_counts = segment_L_talea_data.choral2_counts
segment_L_syncopated_counts = [-1, 1, -2, 3, -5, 8]
segment_L_euclidean_counts = segment_L_talea_data.euclidean_counts
...
segment_L_Cello_instr_pdref = segment_L_instr_pdref.Cello
segment_L_Cello_pd = getattr(segment_L_pitch_data,
                             segment_L_Cello_instr_pdref)
segment_L_Cello_pitch_segment = abjad.PitchSegment(segment_L_Cello_pd)
Cello_music_data = InstrumentMusicData()
Cello_music_data.pitches = segment_L_Cello_pitch_segment.transpose(-12)
Cello_music_data.talea = segment_L_syncopated_counts
Cello_music_data.denominator = 4
Cello_music_data.attachments = [liminal_dynamic, markup.flaut]
