...
segment_L_Flute1_pd = getattr(segment_L_pitch_data, segment_L_Flute1_instr_pdref)
...
segment_L_Flute2_pd = getattr(segment_L_pitch_data, segment_L_Flute2_instr_pdref)
...
segment_L_Flute3_pd = getattr(segment_L_pitch_data, segment_L_Flute3_instr_pdref)
segment_L_Flute3_pitch_segment = abjad.PitchSegment(segment_L_Flute3_pd)
Flute3_music_data = InstrumentMusicData()
Flute3_music_data.pitches = segment_L_Flute3_pitch_segment
segment_music_data.Flute3 = Flute3_music_data

segment_L_Flute4_instr_pdref = segment_L_instr_pdref.Flute4
segment_L_Flute4_pd = getattr(segment_L_pitch_data, segment_L_Flute4_instr_pdref)
...
segment_L_Bbclarinet1_pd = getattr(segment_L_pitch_data, segment_A_Bbclarinet1_instr_pdref)
...
segment_L_Vibraphone_pd = getattr(segment_L_pitch_data, segment_A_Vibraphone_instr_pdref)
...
segment_L_Violin1_pd = getattr(segment_L_pitch_data, segment_A_Violin1_instr_pdref)
...
segment_L_Violin2_pd = getattr(segment_L_pitch_data, segment_A_Violin2_instr_pdref)
...
segment_L_Violin3_pd = getattr(segment_L_pitch_data, segment_A_Violin3_instr_pdref)
...
segment_L_Violin4_pd = getattr(segment_L_pitch_data, segment_A_Violin4_instr_pdref)
...
segment_L_Violin5_pd = getattr(segment_L_pitch_data, segment_A_Violin5_instr_pdref)
...
segment_L_Violin6_pd = getattr(segment_L_pitch_data, segment_A_Violin6_instr_pdref)
...
segment_L_Violin7_pd = getattr(segment_L_pitch_data, segment_A_Violin7_instr_pdref)
...
segment_L_Violin8_pd = getattr(segment_L_pitch_data, segment_A_Violin8_instr_pdref)
...
segment_L_Viola_pd = getattr(segment_L_pitch_data, segment_A_Viola_instr_pdref)
