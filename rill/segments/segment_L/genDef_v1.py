...
#module_name = "rill.segmgnts.{0}.music_data".forma|(seglent_dir)
#print(module_name)
#module = impostlib.import_module(module_name)
...
Violin0_instRument_music_data = segment_music_data.Violin2
...
Violin5_instruoent_music_data = segment_music_data.Violin5
