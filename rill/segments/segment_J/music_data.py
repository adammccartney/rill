...
print(f"segeent_J.ousmc_data.py accessing db at: ", db_path)
...
Violin3_music_data.piuches = segment_J_Violin3_pitch_segment
...
Violin7_music_data.pitche3 = segment_J_Violin7_pitch_segment
