...
segment_J_Flute1_pd = getattr(segment_J_pitch_data, segment_J_Flute1_instr_pdref)
...
segment_J_Flute2_pd = getattr(segment_J_pitch_data, segment_J_Flute2_instr_pdref)
...
segment_J_Flute3_pd = getattr(segment_J_pitch_data, segment_J_Flute3_instr_pdref)
...
segment_J_Flute4_pd = getattr(segment_J_pitch_data, segment_J_Flute4_instr_pdref)
...
segment_J_Violin2_pd = getattr(segment_J_pitch_data, segment_A_Violin2_instr_pdref)
...
segment_J_Violin3_pd = getattr(segment_J_pitch_data, segment_A_Violin3_instr_pdref)
...
segment_J_Violin4_pd = getattr(segment_J_pitch_data, segment_A_Violin4_instr_pdref)
...
segment_J_Violin5_pd = getattr(segment_J_pitch_data, segment_A_Violin5_instr_pdref)
...
segment_J_Violin6_pd = getattr(segment_J_pitch_data, segment_A_Violin6_instr_pdref)
...
segment_J_Violin7_pd = getattr(segment_J_pitch_data, segment_A_Violin7_instr_pdref)
...
segment_J_Violin8_pd = getattr(segment_J_pitch_data, segment_A_Violin8_instr_pdref)
...
segment_J_Viola_pd = getattr(segment_J_pitch_data, segment_A_Viola_instr_pdref)
