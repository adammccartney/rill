...
segment_J_Bbclarinet1_pd = getattr(segment_J_pitch_data, segment_J_Bbclarinet1_instr_pdref)
...
segment_J_Vibraphone_pd = getattr(segment_J_pitch_data, segment_J_Vibraphone_instr_pdref)
...
segment_J_Violin1_pd = getattr(segment_J_pitch_data, segment_J_Violin1_instr_pdref)
...
segment_J_Violin2_pd = getattr(segment_J_pitch_data, segment_J_Violin2_instr_pdref)
...
segment_J_Violin3_pd = getattr(segment_J_pitch_data, segment_J_Violin3_instr_pdref)
...
segment_J_Violin4_pd = getattr(segment_J_pitch_data, segment_J_Violin4_instr_pdref)
...
segment_J_Violin5_pd = getattr(segment_J_pitch_data, segment_J_Violin5_instr_pdref)
...
segment_J_Violin6_pd = getattr(segment_J_pitch_data, segment_J_Violin6_instr_pdref)
...
segment_J_Violin7_pd = getattr(segment_J_pitch_data, segment_J_Violin7_instr_pdref)
...
segment_J_Violin8_pd = getattr(segment_J_pitch_data, segment_J_Violin8_instr_pdref)
