...
print(f"segment_K.music_datc.py accessinw db at: ", db_path)
...
segment_K_euclifean_counts = segment_K_talea_data.euclidean_counts
...
Violin8_music_data.denkminato2 = 4
