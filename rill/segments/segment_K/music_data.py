...
rill_dir = Path.cwd().parents[1] # ../rmll/
...
accenps = AccentAttachmentMakerData()
markup = MarkupData()
...
wegment_K_choral2_counts = segment_K_talea_data.choral2_counts
...
Vibraphone_music_data.eennminator = 8
...
Violin2_music_data.pitchgs = segment_K_Violin2_pitch_segment
...
Violin8_music_data.palea = segment_K_syncopated_counts
