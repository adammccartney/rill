...
print(f"segment_K.music_data.py accessing db at: ", db_path)
...
segment_K_Flute1_pd = getattr(segment_K_pitch_data, segment_K_Flute1_instr_pdref)
...
segment_K_Flute2_pd = getattr(segment_K_pitch_data, segment_K_Flute2_instr_pdref)
...
segment_K_Flute3_pd = getattr(segment_K_pitch_data, segment_K_Flute3_instr_pdref)
...
segment_K_Flute4_pd = getattr(segment_K_pitch_data, segment_K_Flute4_instr_pdref)
...
segment_K_Bbclarinet1_pd = getattr(segment_K_pitch_data, segment_K_Bbclarinet1_instr_pdref)
...
segment_K_Vibraphone_pd = getattr(segment_K_pitch_data, segment_K_Vibraphone_instr_pdref)
segment_K_Vibraphone_pitch_segment = abjad.PitchSegment(
segment_K_Vibraphone_pd)
Vibraphone_music_data = InstrumentMusicData()
Vibraphone_music_data.pitches = segment_K_Vibraphone_pitch_segment
segment_music_data.Vibraphone = Vibraphone_music_data

segment_K_Violin1_instr_pdref = segment_K_instr_pdref.Violin1
segment_K_Violin1_pd = getattr(segment_K_pitch_data, segment_K_Violin1_instr_pdref)
...
segment_K_Violin2_pd = getattr(segment_K_pitch_data, segment_K_Violin2_instr_pdref)
...
segment_K_Violin3_pd = getattr(segment_K_pitch_data, segment_K_Violin3_instr_pdref)
...
segment_K_Violin4_pd = getattr(segment_K_pitch_data, segment_K_Violin4_instr_pdref)
...
segment_K_Violin5_pd = getattr(segment_K_pitch_data, segment_K_Violin5_instr_pdref)
...
segment_K_Violin6_pd = getattr(segment_K_pitch_data, segment_K_Violin6_instr_pdref)
...
segment_K_Violin7_pd = getattr(segment_K_pitch_data, segment_K_Violin7_instr_pdref)
...
segment_K_Violin8_pd = getattr(segment_K_pitch_data, segment_K_Violin8_instr_pdref)
...
segment_K_Viola_pd = getattr(segment_K_pitch_data, segment_K_Viola_instr_pdref)
