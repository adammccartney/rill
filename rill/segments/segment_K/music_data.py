...
segment_K_Bbclarinet1_pd = getattr(segment_K_pitch_data, segment_A_Bbclarinet1_instr_pdref)
...
segment_K_Vibraphone_pd = getattr(segment_K_pitch_data, segment_A_Vibraphone_instr_pdref)
...
segment_K_Violin1_pd = getattr(segment_K_pitch_data, segment_A_Violin1_instr_pdref)
...
segment_K_Violin2_pd = getattr(segment_K_pitch_data, segment_A_Violin2_instr_pdref)
...
segment_K_Violin3_pd = getattr(segment_K_pitch_data, segment_A_Violin3_instr_pdref)
...
segment_K_Violin4_pd = getattr(segment_K_pitch_data, segment_A_Violin4_instr_pdref)
...
segment_K_Violin5_pd = getattr(segment_K_pitch_data, segment_A_Violin5_instr_pdref)
...
segment_K_Violin6_pd = getattr(segment_K_pitch_data, segment_A_Violin6_instr_pdref)
...
segment_K_Violin7_pd = getattr(segment_K_pitch_data, segment_A_Violin7_instr_pdref)
...
segment_K_Violin8_pd = getattr(segment_K_pitch_data, segment_A_Violin8_instr_pdref)
...
segment_K_Viola_pd = getattr(segment_K_pitch_data, segment_A_Viola_instr_pdref)
