...
segment_A_Flute1_pd = getattr(segment_A_pitch_data, segment_A_Flute1_instr_pdref)
...
segment_A_Flute2_pd = getattr(segment_A_pitch_data, segment_A_Flute2_instr_pdref)
...
segment_A_Flute3_pd = getattr(segment_A_pitch_data, segment_A_Flute3_instr_pdref)
...
segment_A_Flute4_pd = getattr(segment_A_pitch_data, segment_A_Flute4_instr_pdref)
...
segment_A_Bbclarinet1_pd = getattr(segment_A_pitch_data, segment_A_Bbclarinet1_instr_pdref)
...
segment_A_Vibraphone_pd = getattr(segment_A_pitch_data, segment_A_Vibraphone_instr_pdref)
...
segment_A_Violin2_pd = getattr(segment_A_pitch_data, segment_A_Violin2_instr_pdref)
...
segment_A_Violin3_pd = getattr(segment_A_pitch_data, segment_A_Violin3_instr_pdref)
...
segment_A_Violin4_pd = getattr(segment_A_pitch_data, segment_A_Violin4_instr_pdref)
...
segment_A_Violin5_pd = getattr(segment_A_pitch_data, segment_A_Violin5_instr_pdref)
...
segment_A_Violin6_pd = getattr(segment_A_pitch_data, segment_A_Violin6_instr_pdref)
...
segment_A_Violin7_pd = getattr(segment_A_pitch_data, segment_A_Violin7_instr_pdref)
...
Violin7_music_data.talea = segment_A_euclidean_talea
segment_music_data.Violin7 = Violin7_music_data

segment_A_Violin8_instr_pdref = segment_A_instr_pdref.Violin8
segment_A_Violin8_pd = getattr(segment_A_pitch_data, segment_A_Violin8_instr_pdref)
