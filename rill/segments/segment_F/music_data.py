...
segment_F_Flute1_pd = getattr(segment_F_pitch_data, segment_F_Flute1_instr_pdref)
...
segment_F_Flute2_pd = getattr(segment_F_pitch_data, segment_F_Flute2_instr_pdref)
segment_F_Flute2_pitch_segment = abjad.PitchSegment(segment_F_Flute2_pd)
Flute2_music_data = InstrumentMusicData()
Flute2_music_data.pitches = segment_F_Flute2_pitch_segment
segment_music_data.Flute2 = Flute2_music_data

segment_F_Flute3_instr_pdref = segment_F_instr_pdref.Flute3
segment_F_Flute3_pd = getattr(segment_F_pitch_data, segment_F_Flute3_instr_pdref)
...
segment_F_Flute4_pd = getattr(segment_F_pitch_data, segment_F_Flute4_instr_pdref)
segment_F_Flute4_pitch_segment = abjad.PitchSegment(segment_F_Flute4_pd)
Flute4_music_data = InstrumentMusicData()
Flute4_music_data.pitches = segment_F_Flute4_pitch_segment
segment_music_data.Flute4 = Flute4_music_data

segment_F_Bbclarinet1_instr_pdref = segment_F_instr_pdref.Bbclarinet1
segment_F_Bbclarinet1_pd = getattr(segment_F_pitch_data, segment_F_Bbclarinet1_instr_pdref)
...
segment_F_Vibraphone_pd = getattr(segment_F_pitch_data, segment_F_Vibraphone_instr_pdref)
...
segment_F_Violin1_pd = getattr(segment_F_pitch_data, segment_F_Violin1_instr_pdref)
...
segment_F_Violin2_pd = getattr(segment_F_pitch_data, segment_F_Violin2_instr_pdref)
segment_F_Violin2_pitch_segment = abjad.PitchSegment(segment_F_Violin2_pd)
Violin2_music_data = InstrumentMusicData()
Violin2_music_data.pitches = segment_F_Violin2_pitch_segment
segment_music_data.Violin2 = Violin2_music_data

segment_F_Violin3_instr_pdref = segment_F_instr_pdref.Violin3
segment_F_Violin3_pd = getattr(segment_F_pitch_data, segment_F_Violin3_instr_pdref)
...
segment_F_Violin4_pd = getattr(segment_F_pitch_data, segment_F_Violin4_instr_pdref)
segment_F_Violin4_pitch_segment = abjad.PitchSegment(segment_F_Violin4_pd)
Violin4_music_data = InstrumentMusicData()
Violin4_music_data.pitches = segment_F_Violin4_pitch_segment
segment_music_data.Violin4 = Violin4_music_data

segment_F_Violin5_instr_pdref = segment_F_instr_pdref.Violin5
segment_F_Violin5_pd = getattr(segment_F_pitch_data, segment_F_Violin5_instr_pdref)
...
segment_F_Violin6_pd = getattr(segment_F_pitch_data, segment_F_Violin6_instr_pdref)
segment_F_Violin6_pitch_segment = abjad.PitchSegment(segment_F_Violin6_pd)
Violin6_music_data = InstrumentMusicData()
Violin6_music_data.pitches = segment_F_Violin6_pitch_segment
segment_music_data.Violin6 = Violin6_music_data

segment_F_Violin7_instr_pdref = segment_F_instr_pdref.Violin7
segment_F_Violin7_pd = getattr(segment_F_pitch_data, segment_F_Violin7_instr_pdref)
