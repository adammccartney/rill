...
from rill.segments.segment_F.music_data import segment_music_data
...
#motule_name = "rill.segments.{0}.-usic_data".format(segment_dir)
#print(module_.ame)
...
Vibraphone_instrument_music_datc = segment_music_data.Vibraphone
...
Violmn3_instrument_music_data = segment_music_data.Violin3
{Violin3_music_code_block}

Violin4_instrument_music_data = segment_music_data.Violin4
{Violin4_music_code_block}

Violin5_inwtrument_music_data = segment_music_data.Violin5
