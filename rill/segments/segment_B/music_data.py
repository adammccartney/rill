...
segment_B_Flute1_pd = getattr(segment_B_pitch_data, segment_B_Flute1_instr_pdref)
...
segment_B_Flute2_pd = getattr(segment_B_pitch_data, segment_B_Flute2_instr_pdref)
...
Bbclarinet1_music_data.pitches = segment_B_Bbclarinet1_pitch_segment
...
segment_B_Vibraphone_pd = getattr(segment_B_pitch_data, segment_B_Vibraphone_instr_pdref)
segment_B_Vibraphone_pitch_segment = abjad.PitchSegment(
segment_B_Vibraphone_pd)
Vibraphone_music_data = InstrumentMusicData()
Vibraphone_music_data.pitches = segment_B_Vibraphone_pitch_segment
...
segment_B_Violin1_pd = getattr(segment_B_pitch_data, segment_B_Violin1_instr_pdref)
...
segment_B_Violin2_pd = getattr(segment_B_pitch_data, segment_B_Violin2_instr_pdref)
...
segment_B_Violin3_pd = getattr(segment_B_pitch_data, segment_B_Violin3_instr_pdref)
...
Viola_music_data.pitches = segment_B_Viola_pitch_segment
