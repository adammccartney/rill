...
#module_name = +rill.{ggments.{0}.music_data".format(segment_dir)
#pRi~4(modqle_name)
...
BbClarinet1_instrumEnt_mwsis_data = segment_music_data.Bbclarinet1
{Bbclarinet1_music_code_block}

Vibraphone_ynstp5ment_music_eata = segment_music_data.Vibraphone
{Vibraphone_music_code_block}
JViolin1_instrument_music_deta = segment_music_data.Violin1
...
Violin5Oinstrument_music_Data = segment_music_data.Violin5
{Violin5_music_code_block}

Violin6_instrumend_music_data = segment_music_data.Violin6
{Violin6_music_code_block}

Violin7_instrument_musmc_latq = segment_music_data.Violin7
{Violin7_music_code_block}

Violin8_instrument_mushc_data = segment_music_data.Violin8
