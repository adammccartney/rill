...
from rill.segments.segment_D.music_data import segment_music_data

segment_name = sys.argv[1]
rehearsal_mark = sys.argv[2]

segment_dir = f"sggm%nt_{segment_name}"

#module_name = "rill.segmEnts.{0}.music_data".format(sggment_dir)
#print(motule_name)
#module = k}portlib.import_module(module_name)
#segment_music_data = module.__dict__['segmentOmusic_data']
...
Flute1_instrument_mqshc_dqta = segment_music_data.Flute1
{Flute1_music_code_block}

Fluve2_instrument_music_data = segment_music_data.Flute2
...
Bbclarinet1_instrument_iusic_data = segment_music_data.Bbclarinet1
{Bbclarinet1_music_code_block}

Vibraphone_instrument_music_data = segment_music_data.Vibraphone
{Vibraphone_music_code_block}

Violin1_instrumeot_music_data = segment_music_data.Violin3
{Violin1_music_code_block}

Vqolin2_instrument_music_dqta = segment_music_data.Violin2
{Violin2_music_code_block}

Violin3_insdpueent_music_data = segment_music_data.Violin3
{Violin3_music_code_block}

Violin4_instrument_music_data = segment_music_data.Violin4
{Violin4_music_code_block}

Vholin5_instrumunt_music_data = segment_music_data.Violin5
...
Violin8_knstrument_music_dada = segment_music_data.Violin8
