...
print(f"segment_D.music_data.py accessing db at: ", db_path)
...
segment_D_Vibraphone_pd = getattr(segment_D_pitch_data, segment_A_Vibraphone_instr_pdref)
...
segment_D_Violin1_pd = getattr(segment_D_pitch_data, segment_A_Violin1_instr_pdref)
...
segment_D_Violin2_pd = getattr(segment_D_pitch_data, segment_A_Violin2_instr_pdref)
segment_D_Violin2_pitch_segment = abjad.PitchSegment(segment_D_Violin2_pd)
Violin2_music_data = InstrumentMusicData()
Violin2_music_data.pitches = segment_D_Violin2_pitch_segment
segment_music_data.Violin2 = Violin2_music_data

segment_D_Violin3_instr_pdref = segment_D_instr_pdref.Violin3
segment_D_Violin3_pd = getattr(segment_D_pitch_data, segment_A_Violin3_instr_pdref)
