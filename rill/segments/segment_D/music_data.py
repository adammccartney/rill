...
segment_D_Bbclarinet1_pd = getattr(segment_D_pitch_data, segment_D_Bbclarinet1_instr_pdref)
...
segment_D_Vibraphone_pd = getattr(segment_D_pitch_data, segment_D_Vibraphone_instr_pdref)
...
segment_D_Violin1_pd = getattr(segment_D_pitch_data, segment_D_Violin1_instr_pdref)
...
segment_D_Violin2_pd = getattr(segment_D_pitch_data, segment_D_Violin2_instr_pdref)
...
segment_D_Violin3_pd = getattr(segment_D_pitch_data, segment_D_Violin3_instr_pdref)
...
segment_D_Violin4_pd = getattr(segment_D_pitch_data, segment_D_Violin4_instr_pdref)
...
segment_D_Violin5_pd = getattr(segment_D_pitch_data, segment_D_Violin5_instr_pdref)
...
segment_D_Violin6_pd = getattr(segment_D_pitch_data, segment_D_Violin6_instr_pdref)
...
segment_D_Violin7_pd = getattr(segment_D_pitch_data, segment_D_Violin7_instr_pdref)
...
segment_D_Violin8_pd = getattr(segment_D_pitch_data, segment_D_Violin8_instr_pdref)
