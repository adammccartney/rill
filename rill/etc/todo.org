...
*** IN-PROGRESS Re-configure ScoreTemplate to reflect final instrumentation
...
*** TODO Find solution for missing instrument name markups
 +  looks like the best solution is to implement the names by hand via the stylesheet.ily
